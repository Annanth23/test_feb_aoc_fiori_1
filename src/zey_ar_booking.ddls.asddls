...
define view entity ZEY_AR_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_AR_BOOKSUPPL as _BookingSupplement
association to parent ZEY_AR_TRAVEL as _Travel on
